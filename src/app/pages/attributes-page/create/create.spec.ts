...
import { CreateAttributePage } from './create';
...
describe('CreateAttributePage', () => {
    let component: CreateAttributePage;
    let fixture: ComponentFixture<CreateAttributePage>;

    beforeEach(async () => {
        await TestBed.configureTestingModule({
            declarations: [ CreateAttributePage ],
            providers: [
    ...
    beforeEach(() => {
        fixture = TestBed.createComponent(CreateAttributePage);
